package com.github.zhangyinhao1234.study.spring_cloud_gateway;
...
public class DemogatewayApplication {
        ...
        return builder.routes().route("path_route", r -> r.path("/get").uri("http://httpbin.org"))
                ...
                .route("hystrix_route",
                        r -> r.host("*.hystrix.org").filters(f -> f.hystrix(c -> c.setName("slowcmd")))
                                .uri("http://httpbin.org"))
                .route("hystrix_fallback_route", r -> r.host("*.hystrixfallback.org").filters(
    ...
    public RouteLocator customRouteLocator2(RouteLocatorBuilder builder) {
        // @formatter:off
        return builder.routes().route("test1", r -> r.path("/baidu/*").uri("http://www.baidu.com"))
                .route("test2", r -> r.path("/sc/**").filters(f ->f.stripPrefix(1)).uri("lb://server-c")).build();
        // @formatter:on
    }
