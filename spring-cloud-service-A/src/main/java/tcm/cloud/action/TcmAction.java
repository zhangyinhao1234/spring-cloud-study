...
import tcm.cloud.queue.kafka.KafkaSender;
import tcm.cloud.queue.rabbit.Sender;
import tcm.cloud.spring_cloud_service_A.TcmServiceAMain;
@RestController
...
//        tcmAction.logger.info("dddd");
        ...
        LoggerAppender.info("zhangsanli");
    }
    ...
    @RequestMapping("/sendMsgkafka")
    public String sendMsgkafka() {
        kafkaSender.sendMessage("你好");
        return "success";
    }
}
